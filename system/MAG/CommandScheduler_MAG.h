...
namespace MCsim
{
	...
	public:
		CommandScheduler_MAG(vector<CommandQueue *> &commandQueues, const map<unsigned int, bool> &requestorTable) : CommandScheduler(commandQueues, requestorTable)
		{
			casBlocking = false;
			indexRT = 0;
			indexHP = 0;
